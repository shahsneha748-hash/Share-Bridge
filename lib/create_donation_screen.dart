...
class _CreateDonationScreenState extends State<CreateDonationScreen> {
  ...
  // ── Color Tokens ─────────────────────────────────────────
  static const kHeader   = Color(0xFF3A6B1E); // dark green header
  static const kInputBg  = Color(0xFFD6E8D0); // input fill (inside cards)
  static const kBorder   = Color(0xFFB0CBA8); // input border
  static const kChipOn   = Color(0xFFC2D9BB); // selected chip fill
  static const kCardBg   = Color(0xFFF2F5F0); // light green section cards
  static const kPageBg   = Color(0xFFFFFFFF); // outer page = WHITE
  ...
  final _categories = [
    ...
    {'id': 'toys',        'label': 'Toys',        'icon': Icons.toys_rounded},
    {'id': 'furniture',   'label': 'Furniture',   'icon': Icons.chair_rounded},
    {'id': 'medicine',    'label': 'Medicine',    'icon': Icons.medication_rounded},
  ...
  Future<void> _pickPhotos() async {
    ...
    if (picked.isNotEmpty) {
      setState(() =>
      _photos = picked.take(5).map((x) => File(x.path)).toList());
    }
  }

  void _handleEdit() => _toast('✎ Edit your fields and re-post');

  void _handleDelete() {
    if (!_confirmDel) {
      setState(() => _confirmDel = true);
      _toast('Tap 🗑 again to confirm delete',
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
              color: active ? kSub : kBorder, width: 1.5),
        ),
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: active ? kHeader : kSub, width: 1.5),
  ...
  Widget _donationStatusSection() => _sectionCard(
  ...
  // ── Manage Post Card ──────────────────────────────────────
  Widget _managePostSection() => _sectionCard(
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      _label('Manage Post'),
      Row(children: [
        // Edit
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: kPageBg, // WHITE outer page
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
                ...
                children: [
                        ...
                        children: [
                          ...
                          TextField(
                            ...
                            style: const TextStyle(
                                color: kText, fontSize: 14),
                            decoration:
                            _inputDecor('Enter pickup location'),
                          ),
                        ]),
                  ),
                  const SizedBox(height: 12),
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            children: _conditions
                                .map((c) => _radioChip(c, c, _condition,
                  ...
                  // Sits on WHITE page bg, full dark green
                  SizedBox(
                    width: double.infinity,
                    child: GestureDetector(
                      onTap: _canSubmit
                      ...
                      child: AnimatedContainer(
                        ...
                        padding: const EdgeInsets.symmetric(
                            vertical: 16),
                        decoration: BoxDecoration(
                          // Active = dark green, disabled = muted border green
    ...
    body: Center(
      child: Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text(
            'Thank you, ${_firstNameController.text}!\nYour donation has been posted.',
