    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            AppHeader(
              title: vm.isEditing ? "Edit Donation" : "Create Donation",
            ),
            Expanded(
              child: Container(
                color: Colors.white,
                child: vm.loading
                  ...
                  child: Column(
                    ...
                    children: [
                            ...
                            children: vm.categories.map((cat) {
                              return Padding(
                                ...
                                child: CategoryChip(
                                  label: cat['label'],
                                  icon: cat['icon'],
                                  isSelected: vm.model.category == cat['id'],
                                  onTap: () => vm.setCategory(cat['id']),
                                ),
                              );
                            }).toList(),
                          ),
                      ...
                      if (vm.isFood) const SizedBox(height: 12),
                      CustomSection(
                        title: "Sub Category",
                        child: CustomTextField(
                      ...
                      CustomSection(
                        ...
                        child: PickupLocationField(
                          ...
                          onCoordinatesPicked: vm.setCoordinates,
                        ),
                      ),
                      const SizedBox(height: 12),
                      CustomSection(
                      ...
                      UploadPhotosSection(
                        ...
                        onPickFromGallery: () => _pickImage(vm, ImageSource.gallery),
                        onPickFromCamera: () => _pickImage(vm, ImageSource.camera),
                        onRemovePhoto: vm.removeImage,
                      ),
                      const SizedBox(height: 12),
                      TagSection(
                        tags: vm.model.tags,
                        onAddTag: () => _showAddTagDialog(context, vm),
